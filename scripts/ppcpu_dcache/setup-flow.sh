...
sed -i '/::env(FP_SIZING)/d' ${design_dir}/openlane/dcache/config.tcl
sed -i '/::env(DIE_AREA)/d' ${design_dir}/openlane/dcache/config.tcl
sed -i '/::env(CLOCK_PERIOD)/d' ${design_dir}/openlane/dcache/config.tcl
