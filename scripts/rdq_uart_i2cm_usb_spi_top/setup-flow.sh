...
sed -i '/::env(PL_TARGET_DENSITY)/d' ${design_dir}/openlane/uart_i2cm_usb_spi_top/config.tcl
sed -i 's/GLB_RT/GRT/g' ${design_dir}/openlane/uart_i2cm_usb_spi_top/config.tcl
