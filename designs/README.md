...
[<u>https://platform.efabless.com/projects/104</u>](https://platform.efabless.com/projects/104)
...
<th><strong>Project Owner</strong></th>
<th><strong>CI Design Name/CI Script Name</strong></th>
</tr>
<tr class="odd">
<th><strong>MPW-2 Shuttle</strong></th>
<th></th>
<th></th>
<th></th>
<th></th>
...
<th>Alperen Bolat</th>
<th>[counter_alperen](./counter_alperen)</th>
</tr>
<tr class="odd">
<th>Caravel-Sermo</th>
<th>116</th>
...
<th>[counter_eeuet](./counter_eeuet)</th>
</tr>
<tr class="header">
...
<th>[multi_encoder](./multi_encoder)</th>
</tr>
<tr class="odd">
<th>FuseRISC</th>
<th>134</th>
...
<th><p>[fuserisc](./fuserisc)</p>
<p>fuserisc core_sram</p>
...
<th>Siva Prasad</th>
<th>[soc_io_expander](./soc_io_expander)</th>
</tr>
<tr class="odd">
<th>SHA1 engine</th>
<th>151</th>
...
<th>Zachary Ellis</th>
<th>[wishbone_CAN](./wishbone_CAN)</th>
</tr>
<tr class="odd">
...
<th>[yonga-lz4-decoder](./yonga-lz4-decoder)</th>
</tr>
<tr class="header">
...
<th>[subservient_SOC](./subservient_SOC)</th>
</tr>
<tr class="odd">
...
<th>Pu Wang</th>
<th>[axi_dma_wrapper](./axi_dma_wrapper)</th>
</tr>
<tr class="header">
<th>caravel_dsp2</th>
<th>180</th>
...
<th>Nguyen Dao</th>
<th>[eFPGA_v3_wrapper](./eFPGA_v3_wrapper)</th>
</tr>
<tr class="odd">
<th>Space_Shuttle</th>
<th>214</th>
...
<th>Ahmad Nofal</th>
<th>[space_controller](./space_controller)</th>
</tr>
<tr class="header">
...
<th>[azadi_soc](./azadi_soc)</th>
</tr>
<tr class="odd">
<th><strong>MPW-3 Shuttle</strong></th>
<th></th>
<th></th>
<th></th>
<th></th>
...
<th><p>[mbist_ctrl](./mbist_ctrl)</p>
<p>mbist_ctrl mbist1</p>
...
<th>Shon Taware</th>
<th>[counter_vsdsram](./counter_vsdsram)</th>
</tr>
<tr class="odd">
...
<th>[counter_efab](./counter_efab)</th>
</tr>
<tr class="header">
...
<th>Andrea Nall</th>
<th>[sudoku-accelerator](./sudoku-accelerator)</th>
</tr>
<tr class="odd">
...
<th>Abdullah YILDIZ</th>
<th>[yonga-serv-accelerator](./yonga-serv-accelerator)</th>
</tr>
<tr class="header">
<th>YONGA-100M Ethernet</th>
<th>436</th>
<th>YONGA-100M Ethernet is based on the implementation of Alex Forencich's 100Mbps Ethernet design.</th>
<th>Abdullah YILDIZ</th>
<th>[yonga-100m-ethernet](./yonga-100m-ethernet)</th>
</tr>
<tr class="odd">
<th>TreePRAM</th>
<th>449</th>
...
<th><p>[crypto_accelerator](./crypto_accelerator)</p>
<p>crypto_accelerator accelerator_top</p></th>
</tr>
<tr class="odd">
<th>caravel_peripheral_extender</th>
<th>458</th>
<th>An attempt to integrate various peripherals like I2C, I2S, UART, SPI, QSPI , JTAG, PWM, GPIO , WS281B led controller to the Caravel SoC via the wishbone bus. The user address space is exploited as the register space for this controller.</th>
<th>Siva Prasad</th>
<th>[peripheral_extender](./peripheral_extender)</th>
</tr>
<tr class="header">
...
<th>[MPW3_Approximate_Multiplier](./MPW3_Approximate_Multiplier)</th>
</tr>
<tr class="odd">
<th>VSDMemSoC</th>
<th>483</th>
...
<th><p>[vsdmemsoc](./vsdmemsoc)</p>
<p>vsdmemsoc rvmyth_core</p></th>
</tr>
<tr class="header">
...
<th>PWM-Generator</th>
<th>Karthi Keyan</th>
<th>[PWM-Generator](./PWM-Generator)</th>
</tr>
<tr class="odd">
...
<th>Giray Pultar</th>
<th>[keyvalue_caravel](./keyvalue_caravel)</th>
</tr>
<tr class="header">
<th>Caravel</th>
<th>515</th>
...
<th>htfab</th>
<th>[rotfpga](./rotfpga)</th>
</tr>
<tr class="header">
<th><strong>MPW-4 Shuttle</strong></th>
<th></th>
<th></th>
<th></th>
<th></th>
...
<th>Manikantasai2</th>
<th><p>[yifive_a2](./yifive_a2)</p>
<p>yifive_a2 clk_buf</p>
...
<th>Azadi mpw4</th>
<th>[counter_azadi](./counter_azadi)</th>
</tr>
<tr class="header">
...
<th>Matt Venn</th>
<th>[counter_mpw4_mv](./counter_mpw4_mv)</th>
</tr>
<tr class="header">
<th>REST</th>
<th>591</th>
...
<th>Sajjad Ahmed</th>
<th>[counter_REST](./counter_REST)</th>
</tr>
<tr class="odd">
...
<th>Matt Venn</th>
<th>[counter_display_mv](./counter_display_mv)</th>
</tr>
<tr class="header">
...
<th>PRANAV LULU</th>
<th>[updown_caravel](./updown_caravel)</th>
</tr>
<tr class="header">
<th>ICESOC</th>
<th>625</th>
...
<th>Nguyen Dao</th>
<th>[counter_ICESOC](./counter_ICESOC)</th>
</tr>
<tr class="odd">
<th>SORIC</th>
<th>635</th>
...
<th>Thinh Pham</th>
<th><p>[soric_project](./soric_project)</p>
<p>soric_project crypto_core</p>
...
<th>Uzair Ahmad</th>
<th>[RAD_HARD_ALU](./RAD_HARD_ALU)</th>
</tr>
<tr class="odd">
<th>Kasirga K0</th>
<th>638</th>
...
<th><p>[kasirga_k0](./kasirga_k0)</p>
<p>kasirga_k0 c0_system_macro</p></th>
</tr>
<tr class="header">
...
<th>[koggestone_adder](./koggestone_adder)</th>
</tr>
<tr class="odd">
...
<th>Harrison Pham</th>
<th><p>[randsack](./randsack)</p>
<p>randsack collapsering_macro</p>
...
<th>htfab</th>
<th>[ks-guitar-2s](./ks-guitar-2s)</th>
</tr>
<tr class="header">
<th>APPROXIMATE Multiplier</th>
<th>664</th>
...
<th>Rana Muhammad</th>
<th>[APPROX_MULT](./APPROX_MULT)</th>
</tr>
<tr class="odd">
<th><strong>MPW-5 Shuttle</strong></th>
<th></th>
<th></th>
<th></th>
<th></th>
...
<th>Dinesh Annayya</th>
<th><p>[riscduino](./riscduino)</p>
<p>riscduino rd_yifive</p></th>
</tr>
<tr class="odd">
<th>mpw5_cache</th>
<th>673</th>
...
<th>Shivani Shah</th>
<th>[mpw5_L1cache](./mpw5_L1cache)</th>
</tr>
<tr class="header">
...
<th>Dinesh Annayya</th>
<th><p>[riscduino_dcore](./riscduino_dcore)</p>
<p>riscduino_dcore rdd_ycr2_iconnect</p></th>
</tr>
<tr class="odd">
<th>PWM</th>
<th>727</th>
...
<th>[counter_TestSOC](./counter_TestSOC)</th>
</tr>
<tr class="odd">
...
<th>Harald Pretl</th>
<th>[IIC_AudioDAC](./IIC_AudioDAC)</th>
</tr>
<tr class="header">
<th>ORDER_PRGA</th>
<th>742</th>
...
<th>Georgios T</th>
<th><p>[mpw5_prga](./mpw5_prga)</p>
<p>mpw5_prga mpw5_prga_tile_clb</p></th>
</tr>
<tr class="odd">
<th>ChristmasTreeController</th>
<th>746</th>
<th>A Christmas tree controller that include : Infrared receiver (protocol NEC), StepMotor controller (full-step, half-step, with strength control), Led string controller (compatibles WS2812B), Pseudo-random generator (32bits)</th>
<th>Julien OURY</th>
<th>[ChirstmasTreeController](./ChirstmasTreeController)</th>
</tr>
<tr class="header">
...
<th>Rameen Anwar</th>
<th>[azadi_soc_iii](./azadi_soc_iii)</th>
</tr>
<tr class="header">
...
<th>Josh Stevens</th>
<th><p>[Actuator_Controller](./Actuator_Controller)</p>
<p>Actuator_Controller AC_actuator_driver_controller</p>
...
<th>Raster_engine</th>
<th>766</th>
<th>An implementation of a rasterization engine using Skywater 130 nm PDK.</th>
<th>Mehmet Fatih Gülakar</th>
<th>[mpw5_raster_engine](./mpw5_raster_engine)</th>
</tr>
<tr class="header">
...
<th>Nguyen Dao</th>
<th>[mpw5_open_eFPGA](./mpw5_open_eFPGA)</th>
</tr>
<tr class="odd">
<th>LBIST-MBIST</th>
<th>771</th>
...
<th>Dinesh Annayya</th>
<th><p>[logic_bist](./logic_bist)</p>
<p>logic_bist LBIST_mbist_top1</p>
...
<th><p>[UETRV_Ecore](./UETRV_Ecore)</p>
<p>UETRV_Ecore UETRV_Core</p>
...
<th>Simple vexriscv based SoC</th>
<th>Lena Hwang</th>
<th>[junga_soc_mpw5](./junga_soc_mpw5)</th>
</tr>
<tr class="header">
...
<th>Dinesh Annayya</th>
<th><p>[riscduino_qcore](./riscduino_qcore)</p>
<p>riscduino_qcore rdq_uart_i2c_usb_spi_top</p>
...
<th>[systolic_array](./systolic_array)</th>
</tr>
<tr class="header">
<th>Asicle</th>
<th>788</th>
...
<th>[hack_soc_wrapper](./hack_soc_wrapper)</th>
</tr>
<tr class="odd">
<th>RNG CHAOS</th>
<th>793</th>
...
<th>796</th>
<th>This project includes two different designs submitted as part of SSCS PICO-2021. The two designs are GPS Baseband Engine, Polysilicon Resistor based Temperature sensor.</th>
<th>Ramakrishna P.V.</th>
<th>[GPS_Baseband](./GPS_Baseband)</th>
</tr>
<tr class="odd">
<th>REST_II</th>
<th>798</th>
...
<th>Sukru Uzun</th>
<th><p>[secure-memory](./secure-memory)</p>
<p>secure-memory secure-memory-proj</p>
